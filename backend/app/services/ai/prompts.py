...
SUMMARY_SYSTEM_PROMPT = """You are Spend Sense, an expert AI financial coach. 
...
4. Output only valid JSON matching the requested schema. No conversational filler, markdown formatting blocks (like ```json), or extra text outside the JSON.
"""
...
PATTERNS_SYSTEM_PROMPT = """You are Spend Sense, an expert AI financial coach. 
...
6. Output only valid JSON matching the requested schema. No conversational filler or formatting blocks.
"""
...
RECOMMENDATIONS_SYSTEM_PROMPT = """You are Spend Sense, an expert AI financial coach. 
...
4. Output only valid JSON matching the requested schema. No conversational filler or formatting blocks.
"""
...
ANOMALIES_SYSTEM_PROMPT = """You are Spend Sense, an expert AI financial coach. 
...
5. Output only valid JSON matching the requested schema. No conversational filler or formatting blocks.
"""
...
MONTHLY_REVIEW_SYSTEM_PROMPT = """You are Spend Sense, an expert AI financial coach. 
